...
# When("the CLI is invoked with the name {string}") covers all string-name
# scenarios including the escape-sequence case; Cucumber resolves \e in
# Gherkin double-quoted strings to the literal ESC byte before passing here.
